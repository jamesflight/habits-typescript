...
const fetchUnprocessedAirtableRows = () => {
    return rxjs_1.from(node_fetch_1.default("https://api.airtable.com/v0/appvcDcxH8llgwoN7/Table%201?&view=Grid%20view&filterByFormula=NOT(Processed = 1)", {
        headers: {
...
trigger
    ...
    return filtered;
}), operators_1.map(addRewardToAirtableRow), 
// rxFilter((row: IAirtableRow) => row.fields.Reward ? true : false),
operators_1.concatMap((row) => {
